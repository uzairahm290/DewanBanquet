            ...
            {navItems.map((item, index) => (
              ...
              <div className="lg:hidden p-6 border-t border-[#d4af37]/30">
                ...
                <div className="flex items-center justify-center space-x-3">
                  <a href="https://www.tiktok.com/@dewanbanquet" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/5 hover:bg-[#d4af37]/20 border border-white/10 hover:border-[#d4af37]/40 rounded-lg flex items-center justify-center transition-all duration-300 group backdrop-blur-sm">
