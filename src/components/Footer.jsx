      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-12 mb-8 sm:mb-12 lg:mb-16">
          ...
          <div ref={el => sectionRefs.current[3] = el} className="sm:col-span-2 lg:col-span-1">
            <h3 className="text-[#d4af37] text-base sm:text-lg font-semibold mb-4 sm:mb-6 tracking-wider uppercase">Follow Us</h3>
            <ul className="space-y-2 sm:space-y-3 lg:space-y-4">
        ...
        <div className="border-t border-white/10 pt-6 sm:pt-8">
          <div className="flex flex-col space-y-4 sm:space-y-0 sm:flex-row sm:justify-between sm:items-center">
            ...
            <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-6 lg:space-x-8 text-xs sm:text-sm">
